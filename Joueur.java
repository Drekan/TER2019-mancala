...
public abstract class Joueur {
	...
	public int getNumeroJoueur() {return this.numeroJoueur;}
	public void setNumeroJoueur(int numeroJoueur) {	this.numeroJoueur = numeroJoueur;}
	
	//methods :
	public abstract void jouerUnCoup(int caseJouer,GameManagerAwale gameManagerAwale);//mise a jour des valeurs du plateau
	public abstract int getJeu();// avoir le coup que le joueur a choisis
